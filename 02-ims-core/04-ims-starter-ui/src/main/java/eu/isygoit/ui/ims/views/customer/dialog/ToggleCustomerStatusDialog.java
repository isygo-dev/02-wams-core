    ...
    public ToggleCustomerStatusDialog(CustomerManagementView parentView,
        ...
        super(
                ...
                currentStatus == IEnumEnabledBinaryStatus.Types.ENABLED
                        ? I18n.t("ims.customer.dialog.toggle.message.disable")
                        : I18n.t("ims.customer.dialog.toggle.message.enable"),
                onSuccess,
        ...
        setOkButtonText(currentStatus == IEnumEnabledBinaryStatus.Types.ENABLED ? I18n.t("ims.customer.dialog.toggle.button.disable") : I18n.t("ims.customer.dialog.toggle.button.enable"));
        setWidth("450px");
    }
    ...
    protected boolean onOk() {
        ...
        try {
            ...
            if (!response.getStatusCode().is2xxSuccessful()) {
                append(I18n.t("ims.customer.dialog.toggle.failed", response.getStatusCodeValue()));
                return false;
            }

            append(I18n.t("ims.customer.dialog.toggle.success." + (newStatus == IEnumEnabledBinaryStatus.Types.ENABLED ? "enable" : "disable")));
            return true;
        } catch (FeignException ex) {
            append(extractErrorMessage(ex));
        } catch (Exception e) {
            append(I18n.t("ims.customer.dialog.toggle.error", e.getMessage()));
        } finally {
