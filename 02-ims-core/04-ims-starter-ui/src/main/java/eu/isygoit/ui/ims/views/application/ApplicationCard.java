...
public class ApplicationCard extends BaseCard<ApplicationManagementView, ApplicationService> {
    ...
    protected List<Button> buildActionButtons() {
        ...
        toggleStatusBtn = createToggleButton(
                application.getAdminStatus() == IEnumEnabledBinaryStatus.Types.ENABLED,
                I18n.t("ims.app.card.enable.tooltip"),
                I18n.t("ims.app.card.disable.tooltip"),
                this::openToggleStatusDialog
        );

        Button deleteBtn = createDeleteButton(I18n.t("ims.app.card.delete.tooltip"),
                () -> new DeleteApplicationDialog(parentView, objectService, application.getId(), () -> {
                    if (onRefresh != null) onRefresh.run();
                }).open());
