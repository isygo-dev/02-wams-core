...
public class ImsExceptionHandler extends ControllerExceptionHandler {
     ...
     */
    @Autowired
    public ImsExceptionHandler(LocaleService localeService, AppProperties appProperties, IMsgService msgService, AppParameterControllerApi appParameterService) {
