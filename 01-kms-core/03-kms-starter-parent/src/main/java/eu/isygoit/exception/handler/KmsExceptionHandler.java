...
public class KmsExceptionHandler extends ControllerExceptionHandler {
     ...
     */
    @Autowired
    public KmsExceptionHandler(ApplicationContextService applicationContextService, LocaleService localeService, AppProperties appProperties, IMsgService msgService, AppParameterControllerApi appParameterService) {
