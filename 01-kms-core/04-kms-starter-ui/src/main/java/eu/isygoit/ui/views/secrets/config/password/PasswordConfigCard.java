...
import eu.isygoit.ui.views.secrets.config.password.dialog.DeletePasswordConfigDialog;
import eu.isygoit.ui.views.secrets.config.password.dialog.UpdatePasswordConfigDialog;
