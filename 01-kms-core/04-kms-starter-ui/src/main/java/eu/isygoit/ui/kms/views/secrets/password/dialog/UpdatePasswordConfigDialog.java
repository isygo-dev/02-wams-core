...
public class UpdatePasswordConfigDialog extends BaseActionDialog {
    ...
    public UpdatePasswordConfigDialog(PasswordConfigService configService, PasswordConfigDto dto, Runnable onSuccess) {
        super(I18n.t("kms.password.dialog.update.title"), onSuccess);
    ...
    protected boolean onOk() {
        ...
        try {
            ...
            if (response.getStatusCode().is2xxSuccessful()) {
                append(I18n.t("kms.password.dialog.update.success"));
                return true;
            } else {
                append(I18n.t("kms.password.dialog.update.failed.status", response.getStatusCode()));
                return false;
            }
            ...
            append(I18n.t("kms.password.dialog.update.failed", ex.getMessage()));
            return false;
        }
    }
}