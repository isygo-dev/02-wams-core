package eu.isygoit.ui.views.kms.cryptography.random;
...
import eu.isygoit.ui.views.kms.cryptography.random.dialog.CreateRandomKeyDialog;
...
public class RandomKeyView extends Composite<VerticalLayout> {
    ...
    private void loadKeys() {
        ...
        try {
            ...
            Notification.show("Failed to load random keys: " + e.getMessage(), 5000,
    ...
    private void updatePaginationDisplay() {
        ...
        totalCountLabel.setText(String.format("%d keys", totalElements));
    ...
    private void renderCards(List<RandomKeyDto> keys) {
        ...
        if (keys.isEmpty()) {
            ...
            H4 emptyTitle = new H4("No random keys found");
            Paragraph emptyDesc = new Paragraph("Click 'Create' to generate a new random key.");
