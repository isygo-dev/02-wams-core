package eu.isygoit.ui.views.secrets.config.digest;
...
import eu.isygoit.ui.views.secrets.config.digest.dialog.DeleteDigestConfigDialog;
import eu.isygoit.ui.views.secrets.config.digest.dialog.UpdateDigestConfigDialog;
