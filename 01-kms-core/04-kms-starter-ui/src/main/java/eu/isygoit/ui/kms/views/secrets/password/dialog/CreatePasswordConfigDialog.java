...
public class CreatePasswordConfigDialog extends BaseActionDialog {
    ...
    public CreatePasswordConfigDialog(PasswordConfigService configService, Runnable onSuccess) {
        super(I18n.t("kms.password.dialog.create.title"), onSuccess);
    ...
    private void buildForm() {
        codeField = new TextField(I18n.t("kms.password.dialog.field.code"));
        codeField.setRequired(true);
        codeField.setRequiredIndicatorVisible(true);
        codeField.setPlaceholder(I18n.t("kms.password.dialog.field.code.placeholder"));
    ...
    protected boolean onOk() {
        ...
        if (!StringUtils.hasText(code)) {
            append(I18n.t("kms.password.dialog.field.code.required"));
            return false;
        }
        ...
        try {
            ...
            if (response.getStatusCode().is2xxSuccessful()) {
                append(I18n.t("kms.password.dialog.create.success"));
                return true;
            } else {
                append(I18n.t("kms.password.dialog.create.failed", response.getStatusCode()));
                return false;
            }
            ...
            append(I18n.t("kms.password.dialog.creation.failed", ex.getMessage()));
            return false;
        }
    }
}