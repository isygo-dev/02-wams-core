package eu.isygoit.ui.views.kms.secrets.peb;
...
import eu.isygoit.ui.views.kms.secrets.peb.dialog.CreatePEBConfigDialog;
...
public class PEBConfigView extends VerticalLayout {
    ...
    private void buildUI() {
        ...
        H2 header = new H2("PEB Configurations");
    ...
    private void renderCards() {
        ...
        if (currentPageContent.isEmpty()) {
            ...
            Paragraph emptyDesc = new Paragraph("Click 'Create Config' to add a PEB configuration.");
