...
public class DmsExceptionHandler extends ControllerExceptionHandler {
    ...
    @Autowired
    public DmsExceptionHandler(LocaleService localeService, AppProperties appProperties, IMsgService msgService, AppParameterControllerApi appParameterService) {
