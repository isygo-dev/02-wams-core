...
public class CmsExceptionHandler extends ControllerExceptionHandler {
    ...
    @Autowired
    public CmsExceptionHandler(LocaleService localeService, AppProperties appProperties, IMsgService msgService, AppParameterControllerApi appParameterService) {
