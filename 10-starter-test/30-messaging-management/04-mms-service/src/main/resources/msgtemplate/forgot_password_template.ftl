...
<head>
    ...
    <title>Webapp Email template</title><!--[if (mso 16)]>
    <style type="text/css">
        a {
...
<div dir="ltr" class="es-wrapper-color" lang="en" style="background-color:#EDEDED"><!--[if gte mso 9]>
        ...
        <tr>
            <td valign="top" style="padding:0;Margin:0">
                                                            ...
                                                            <td align="center" style="padding:0;Margin:0;font-size:0px">
                                                                <a target="_blank" href="${V_DOMAIN_URL}"
                                                                   style="mso-line-height-rule:exactly;text-decoration:underline;color:#EDEDED;font-size:14px"><img
                                                                            src="https://isygo-it.eu/assets/images/logo.png"
                                                                            alt="Logo"
                                                                            style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                            title="Logo" width="252" class="adapt-img"></a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:Lexend, Arial, sans-serif;line-height:21px;letter-spacing:0;color:#2C2C2C;font-size:14px">
                                                                    You have requested to reset your password access to
                                                                    your web-app account.
                                                                    Click the button below to confirm this action and
                                                                    access the page of modification.
                                                                </p>
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:Lexend, Arial, sans-serif;line-height:21px;letter-spacing:0;color:#2C2C2C;font-size:14px">
                                                                    If you are not the originator of this request,
                                                                ...
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:Lexend, Arial, sans-serif;line-height:21px;letter-spacing:0;color:#2C2C2C;font-size:14px">
                                                                    Attention: for safety reasons, this link is only
                                                                    valid for 24 hours and will work only once.
                                                                </p>
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:Lexend, Arial, sans-serif;line-height:21px;letter-spacing:0;color:#2C2C2C;font-size:14px">
                                                                    If you asked reset your password with several times,
                                                                    please use the last link sent.
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0"><!--[if mso]>
                                                                <a href="${V_DOMAIN_URL}" target="_blank"
                                                                   hidden>
                                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                                 xmlns:w="urn:schemas-microsoft-com:office:word"
                                                                                 esdevVmlButton
                                                                                 href="${V_RESET_PWD_URL}${V_RESET_TOKEN}"
                                                                                 style="height:41px; v-text-anchor:middle; width:268px"
                                                                                 arcsize="50%" stroke="f"
                                                                                 fillcolor="#ff4a4a">
                                                                ...
                                                                <span class="es-button-border msohide"
                                                                      style="border-style:solid;border-color:#2CB543;background:#3e60a6;border-width:0px;display:inline-block;border-radius:30px;width:auto;mso-hide:all">
                                                                    <a
                                                                            href="${V_RESET_PWD_URL}${V_RESET_TOKEN}"
                                                                            class="es-button" target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#FFFFFF;font-size:18px;padding:10px 30px 10px 30px;display:inline-block;background:#3e60a6;border-radius:30px;font-family:Lexend, Arial, sans-serif;font-weight:normal;font-style:normal;line-height:22px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #FF4A4A">
                                                                        Reset your password
                                                                    </a>
                                                                </span>
                                                                <!--<![endif]--></td>
                ...
                <table cellpadding="0" cellspacing="0" class="es-content" align="center" role="none"
                    ...
                    <tr>
                        <td align="center" style="padding:0;Margin:0">
                            <table bgcolor="#2C2C2C" class="es-content-body" align="center" cellpadding="0"
                                   cellspacing="0"
                                   style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#2c2c2c;width:600px"
                                   role="none">
                                <tr>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center" class="es-m-txt-c"
                                                                style="padding:0;Margin:0;padding-bottom:15px"><h1
                                                                        style="Margin:0;font-family:Montaga, Arial, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:30px;font-style:normal;font-weight:normal;line-height:36px;color:#ffffff">
                                                                    We here to help</h1></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center" class="es-m-p0r es-m-p0l"
                                                                ...
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:Lexend, Arial, sans-serif;line-height:21px;letter-spacing:0;color:#ffffff;font-size:14px">
                                                                    ...
                                                                    this process, our friendly support team is here to
                                                                    help.</p></td>
                                                        </tr>
                                                    </table>
                                                </td>
                            ...
                            <table class="es-footer-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <table style="width:540px" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="width:235px" valign="top"><![endif]-->
                                            ...
                                            <tr>
                                                <td class="es-m-p20b" align="left"
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                style="padding:0;Margin:0;padding-bottom:5px"><h1
                                                                        style="Margin:0;font-family:Montaga, Arial, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:30px;font-style:normal;font-weight:normal;line-height:36px;color:#2C2C2C">
                                                                    Contact Us</h1></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left"
