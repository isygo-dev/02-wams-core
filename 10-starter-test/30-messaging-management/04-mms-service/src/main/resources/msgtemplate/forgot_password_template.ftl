...
<head>
    ...
    <style type="text/css">
        ...
        a { color: #0C66E4; }
        .btn:hover { background-color: #0055CC !important; }
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <table role="presentation" cellpadding="0" cellspacing="0" width="64" height="64" style="width:64px;height:64px;background-color:#E9F2FF;border-radius:32px">
                                        <tr>
                                            <td align="center" valign="middle">
                                                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Password reset">
                                                    <rect x="5" y="11" width="14" height="9" rx="2" stroke="#0C66E4" stroke-width="1.6"/>
                                                    <path d="M8 11V8a4 4 0 0 1 7.4-2.1" stroke="#0C66E4" stroke-width="1.6" stroke-linecap="round"/>
                                                    <path d="M15.4 5.9 17 4.3M17 4.3 15.6 3M17 4.3l1.3 1.3" stroke="#0C66E4" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <tr>
                                <td align="center" style="padding-bottom:12px">
                                    <h1 style="margin:0;font-size:22px;line-height:28px;font-weight:600;color:#172B4D">Reset your password</h1>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding-bottom:28px;font-size:15px;line-height:23px;color:#44546F">
                                    Hi ${V_FULLNAME},<br><br>
                                    We received a request to reset the password on your account. Click the button below to choose a new one.
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="padding-bottom:8px;font-size:14px;line-height:21px;color:#626F86">
                                    For your security, this link is valid for <strong>24 hours</strong> and can only be used once. If you requested it more than once, only the most recent link will work.
                                </td>
                            </tr>
                            <tr>
