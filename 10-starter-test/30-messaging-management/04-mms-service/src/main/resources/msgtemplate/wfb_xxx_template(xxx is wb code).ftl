                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center" style="padding-bottom:20px">
                                    <table role="presentation" cellpadding="0" cellspacing="0" width="64" height="64" style="width:64px;height:64px;background-color:#F3F0FD;border-radius:32px">
                                        <tr>
                                            <td align="center" valign="middle">
                                                <svg width="27" height="27" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Workflow board">
                                                    <rect x="3" y="4" width="18" height="16" rx="2" stroke="#6E5DC6" stroke-width="1.6"/>
                                                    <path d="M8 8v9M14 8v5M18 8v11" stroke="#6E5DC6" stroke-width="1.6" stroke-linecap="round"/>
                                                </svg>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td align="center" style="padding-bottom:12px">
                                    <h1 style="margin:0;font-size:22px;line-height:28px;font-weight:600;color:#172B4D">Workflow board updated</h1>
                                </td>
                            </tr>
                            <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding:0 10px">
                                                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                                <path d="M4 12h15M13 6l6 6-6 6" stroke="#8590A2" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
                                                            </svg>
                                                        </td>
