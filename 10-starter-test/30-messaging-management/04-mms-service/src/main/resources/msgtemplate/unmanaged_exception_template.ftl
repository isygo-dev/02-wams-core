...
<head>
    ...
    <title>Unmanaged exception</title>
    <!--[if gte mso 9]>
    <xml>
    ...
    <style type="text/css">
        ...
        a { color: #0C66E4; }
        .stack { font-family: 'Courier New', Courier, monospace; }
...
<div style="display:none;max-height:0;overflow:hidden;opacity:0">
    An unmanaged exception was raised — details attached below. &#8203;&#8203;&#8203;&#8203;&#8203;&#8203;&#8203;&#8203;&#8203;&#8203;&#8203;&#8203;&#8203;
</div>
            ...
            <table role="presentation" class="wrap" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:600px">
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center" style="padding-bottom:20px">
                                    <table role="presentation" cellpadding="0" cellspacing="0" width="64" height="64" style="width:64px;height:64px;background-color:#FFECEB;border-radius:32px">
                                        <tr>
                                            <td align="center" valign="middle">
                                                <svg width="27" height="27" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Exception alert">
                                                    <path d="M12 3 2 20h20L12 3Z" stroke="#C9372C" stroke-width="1.6" stroke-linejoin="round"/>
                                                    <path d="M12 10v4" stroke="#C9372C" stroke-width="1.8" stroke-linecap="round"/>
                                                    <circle cx="12" cy="17" r="1" fill="#C9372C"/>
                                                </svg>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td align="center" style="padding-bottom:12px">
                                    <h1 style="margin:0;font-size:22px;line-height:28px;font-weight:600;color:#172B4D">Unmanaged exception</h1>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding-bottom:16px;font-size:15px;line-height:23px;color:#44546F">
                                    An unhandled exception was raised by the application. Details are included below for investigation.
                                </td>
                            </tr>
                            <tr>
                                <td style="padding:16px;background-color:#172B4D;border-radius:6px">
                                    <div class="stack" style="font-size:12px;line-height:19px;color:#F4F5F7;white-space:pre-wrap;word-break:break-word">${V_EXCEPTION}</div>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td align="center" style="padding:24px 12px 12px;font-size:12px;line-height:18px;color:#8590A2">
                        ...
                        This is an automated system alert, please don't reply directly to this email.
                    </td>
                </tr>
            </table>
        </td>
