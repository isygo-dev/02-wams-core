                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="center" valign="middle">
                                                <svg width="28" height="28" viewBox="0 0 24 24" fill="none"
                                                    ...
                                                    <path d="M14 10a4 4 0 1 0-3.999-4.29L3 12.71V17h4v-2h2v-2h2l1.29-1.29A4 4 0 0 0 14 10Z"
                                                          stroke="#0C66E4" stroke-width="1.6" stroke-linejoin="round"/>
                            ...
                            <tr>
                                <td style="padding-bottom:20px;font-size:15px;line-height:23px;color:#44546F">
                                    Hi ${V_FULLNAME},<br><br>
                                    Use the code below to finish signing in. It's only valid for a short time, so enter
                                    it soon.
                                </td>
                            </tr>
                            <tr>
                                <td align="center" style="padding-bottom:20px">
                                    <table role="presentation" cellpadding="0" cellspacing="0"
                                           style="background-color:#F4F5F7;border:1px dashed #B3D4FF;border-radius:8px">
                                        <tr>
                                            <td class="otp-code" align="center"
                                                style="padding:16px 32px;font-size:34px;line-height:38px;font-weight:700;letter-spacing:10px;color:#0C66E4">
                                                ${V_OTP_CODE}
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td style="padding-bottom:8px;font-size:14px;line-height:21px;color:#626F86">
                                    This code expires in <strong>${V_OTP_LIFETIME_IN_M} minutes</strong> and can only be
                                    used once. If you requested it more than once, only the most recent code will work.
                                </td>
                            </tr>
                            <tr>
                                <td style="font-size:14px;line-height:21px;color:#626F86">
                                    Didn't request this? You can safely ignore this email — your account is still
                                    secure.
                                </td>
                            </tr>
                        </table>
