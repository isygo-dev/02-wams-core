                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:Lexend, Arial, sans-serif;line-height:21px;letter-spacing:0;color:#2C2C2C;font-size:14px">
                                                                    <br></p>
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:Lexend, Arial, sans-serif;line-height:21px;letter-spacing:0;color:#2C2C2C;font-size:14px">
                                                                    Board ${V_BOARD_NAME} was updated.
                                                                </p>
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:Lexend, Arial, sans-serif;line-height:21px;letter-spacing:0;color:#2C2C2C;font-size:14px">
                                                                    The state of the item : ${V_ITEM_TITLE} has been
                                                                    updated from status ${V_FROM_STATE} to
                                                                    status ${V_TO_STATE}
                                                                </p>
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:Lexend, Arial, sans-serif;line-height:21px;letter-spacing:0;color:#2C2C2C;font-size:14px">
                                                                    <br>
                                                                ...
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:Lexend, Arial, sans-serif;line-height:21px;letter-spacing:0;color:#2C2C2C;font-size:14px">
                                                                    Attention: if the changes are suspicious please
                                                                    contact
                                                                    your domain admin!.
                                                                </p>
                                                            </td>
