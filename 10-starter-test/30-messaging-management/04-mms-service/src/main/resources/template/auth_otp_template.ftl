                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:Lexend, Arial, sans-serif;line-height:21px;letter-spacing:0;color:#2C2C2C;font-size:14px">
                                                                    Your One-Time Password (OTP) is ${V_OTP_CODE}
                                                                </p>
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:Lexend, Arial, sans-serif;line-height:21px;letter-spacing:0;color:#2C2C2C;font-size:14px">
                                                                ...
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:Lexend, Arial, sans-serif;line-height:21px;letter-spacing:0;color:#2C2C2C;font-size:14px">
                                                                    Attention: for safety reasons, this password is only
                                                                    valid for ${V_OTP_LIFETIME_IN_M} minutes and will
                                                                    work only once.
                                                                </p>
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:Lexend, Arial, sans-serif;line-height:21px;letter-spacing:0;color:#2C2C2C;font-size:14px">
                                                                    If you asked for OTP with several times, please use
                                                                    the last one sent.
                                                                </p>
                                                            </td>
                                                        </tr>
