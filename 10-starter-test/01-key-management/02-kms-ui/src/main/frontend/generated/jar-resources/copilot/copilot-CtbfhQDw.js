...
function xa(e, t) {
    ...
    function a(s, l) {
        var c, u, d = Ze(s)[g],
            v = new xe(l, (c = (u = n.options_) == null ? void 0 : u.enhancer) != null ? c : Ne, process.env.NODE_ENV !== "production" ? d.name_ + "." + i.toString() : "ObservableObject." + i.toString(), !1);
...
var Ua = {
    ...
    }, x = /* @__PURE__ */ hi(Pi, Ua), $i = "computed", Fa = "computed.struct", Vn = /* @__PURE__ */ Zn($i),
    Ba = /* @__PURE__ */ Zn(Fa, {
...
var er = "action", ss = "action.bound", Fi = "autoAction", ls = "autoAction.bound", Bi = "<unnamed action>",
    Ln = /* @__PURE__ */ Nt(er), cs = /* @__PURE__ */ Nt(ss, {
        bound: !0
    }), zn = /* @__PURE__ */ Nt(Fi, {
        autoAction: !0
    }), us = /* @__PURE__ */ Nt(ls, {
...
function tr(e, t, n) {
    ...
    var a = (r = n.name) != null ? r : process.env.NODE_ENV !== "production" ? "Reaction@" + B() : "Reaction",
        s = Ae(a, n.onError ? fs(n.onError, t) : t), l = !n.scheduler && !n.delay, c = Ki(n), u = !0, d = !1, v,
        h = n.compareStructural ? Be.structural : n.equals || Be.default, b = new te(a, function () {
            u || l ? E() : d || (d = !0, c(E));
...
var An = /* @__PURE__ */ Oi("flow"), _s = /* @__PURE__ */ Oi("flow.bound", {
    ...
    var r = t, i = r.name || "<unnamed flow>", o = function () {
        var s = this, l = arguments, c = ++bs, u = Ae(i + " - runid: " + c + " - init", r).apply(s, l), d, v = void 0,
            h = new Promise(function (b, E) {
                var S = 0;
                d = E;
...
var Ps = {}, fe = "add", Xt = "delete", Qi = /* @__PURE__ */ function () {
    ...
    return t.has_ = function (r) {
        ...
        J(this.keysAtom_), ae(function () {
            var c,
                u = new xe(i, o.enhancer_, process.env.NODE_ENV !== "production" ? o.name_ + "." + Tn(r) : "ObservableMap.key", !1);
...
Extending builtins is not supported.`), e;
    ...
    var r = (n = t?.name) != null ? n : process.env.NODE_ENV !== "production" ? (P(e) ? "ObservableObject" : e.constructor.name) + "@" + B() : "ObservableObject",
        i = new Un(e, /* @__PURE__ */ new Map(), String(r), La(t));
    return sn(e, g, i), e;
}
...
const zs = Symbol.for("react.portal"), Us = Symbol.for("react.fragment"), Fs = Symbol.for("react.strict_mode"),
    Bs = Symbol.for("react.profiler"), Hs = Symbol.for("react.provider"), qs = Symbol.for("react.context"),
    so = Symbol.for("react.forward_ref"), Ks = Symbol.for("react.suspense"), Ws = Symbol.for("react.suspense_list"),
    Gs = Symbol.for("react.memo"), Ys = Symbol.for("react.lazy");
...
const gn = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), Ve = "copilot-", sl = "24.9.2", ll = "undefined",
    $u = "attention-required", Du = "https://plugins.jetbrains.com/plugin/23758-vaadin",
    ku = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode",
    Tu = "https://marketplace.eclipse.org/content/vaadin-tools";
...
function Ol(e) {
    ...
    for (; t && t !== document.body;) {
        const n = window.getComputedStyle(t), r = n.overflowY, i = n.overflowX,
            o = /(auto|scroll)/.test(r) && t.scrollHeight > t.clientHeight,
            a = /(auto|scroll)/.test(i) && t.scrollWidth > t.clientWidth;
        if (o || a)
            return t;
        t = Hn(t);
    }
...
class Il {
    constructor() {
        this.supportsHilla = !0, this.springSecurityEnabled = !1, this.springJpaDataEnabled = !1, this.springApplication = !1, this.urlPrefix = "", this.serverVersions = [], this.clientVersions = [{
            name: "Browser",
 ...
 */
const Lt = globalThis,
    ar = Lt.ShadowRoot && (Lt.ShadyCSS === void 0 || Lt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype,
    sr = Symbol(), Fr = /* @__PURE__ */ new WeakMap();
let _o = class {
    constructor(t, n, r) {
...
const {
        ...
        getOwnPropertyNames: Fl,
        getOwnPropertySymbols: Bl,
        getPrototypeOf: Hl
    } = Object, bn = globalThis, Hr = bn.trustedTypes, ql = Hr ? Hr.emptyScript : "",
    Kl = bn.reactiveElementPolyfillSupport, vt = (e, t) => e, qn = {
        toAttribute(e, t) {
            switch (t) {
                case Boolean:
                    e = e ? ql : null;
    ...
    qr = {attribute: !0, type: String, converter: qn, reflect: !1, useDefault: !1, hasChanged: yo};
...
let Le = class extends HTMLElement {
    ...
    static getPropertyDescriptor(t, n, r) {
        const {get: i, set: o} = Ul(this.prototype, t) ?? {
            get() {
                return this[n];
            }, set(a) {
                this[n] = a;
    ...
    _$AK(t, n) {
        ...
        if (i !== void 0 && this._$Em !== i) {
            const o = r.getPropertyOptions(i),
                a = typeof o.converter == "function" ? {fromAttribute: o.converter} : o.converter?.fromAttribute !== void 0 ? o.converter : qn;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const lr = globalThis, rn = lr.trustedTypes, Wr = rn ? rn.createPolicy("lit-html", {createHTML: (e) => e}) : void 0,
    wo = "$lit$", de = `lit$${Math.random().toFixed(9).slice(2)}$`, Eo = "?" + de, Yl = `<${Eo}>`, De = document,
    Et = () => De.createComment(""), At = (e) => e === null || typeof e != "object" && typeof e != "function",
    cr = Array.isArray, Xl = (e) => cr(e) || typeof e?.[Symbol.iterator] == "function", Cn = `[ 	
\f\r]`, ot = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Gr = /-->/g, Yr = />/g,
    ye = RegExp(`>|${Cn}(?:([^\\s"'>=/]+)(${Cn}*=${Cn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Xr = /'/g, Jr = /"/g, Ao = /^(?:script|style|textarea|title)$/i,
    Oo = (e) => (t, ...n) => ({_$litType$: e, strings: t, values: n}), ee = Oo(1), Wu = Oo(2),
    he = Symbol.for("lit-noChange"), A = Symbol.for("lit-nothing"), Zr = /* @__PURE__ */ new WeakMap(),
...
class et {
    ...
    $(t) {
        const {values: n, _$litType$: r} = t,
            i = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = Ot.createElement(xo(r.h, r.h[0]), this.options)), r);
...
class tc extends _n {
    ...
    _$AI(t, n = this) {
        ...
        const r = this._$AH,
            i = t === A && r !== A || t.capture !== r.capture || t.once !== r.once || t.passive !== r.passive,
            o = t !== A && (r === A || i);
