...
@Table(name = SchemaTableConstantName.T_WORKFLOW, uniqueConstraints = {
        ...
        @UniqueConstraint(name = SchemaUcConstantName.UC_WORKFLOW_TENANT_NAME,
...
public class Workflow extends AuditableCancelableEntity<Long> implements ITenantAssignable, ICodeAssignable {
